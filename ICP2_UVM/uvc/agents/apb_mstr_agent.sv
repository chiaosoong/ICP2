...
class apb_mstr_agent extends uvm_agent;
    ...
    // ca_monitor instance for observing kernel/IFM data
    ca_monitor              ca_mon;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        // always build CA monitor to observe kernel/IFM data from the accelerator
        ca_mon = ca_monitor::type_id::create("ca_mon", this);
