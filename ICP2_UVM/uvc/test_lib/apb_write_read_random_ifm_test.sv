class apb_write_read_random_ifm_test extends apb_base_test;
    `uvm_component_utils(apb_write_read_random_ifm_test)

    // constructor function
    function new(string name="apb_write_read_random_ifm_test", uvm_component parent=null);
...
endclass: apb_write_read_random_ifm_test